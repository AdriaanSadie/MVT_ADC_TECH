...
--               c:/work/Technology/Vivado/adc_mvt/adc_mvt.gen/sources_1/bd/mvt_top/ip/mvt_top_util_ds_buf_0_2/mvt_top_util_ds_buf_0_2_sim_netlist.vhdl
...
entity mvt_top_util_ds_buf_0_2_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of mvt_top_util_ds_buf_0_2_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of mvt_top_util_ds_buf_0_2_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of mvt_top_util_ds_buf_0_2_util_ds_buf : entity is "IBUFDS";
  attribute C_MODE : string;
  attribute C_MODE of mvt_top_util_ds_buf_0_2_util_ds_buf : entity is "PERFORMANCE";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of mvt_top_util_ds_buf_0_2_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of mvt_top_util_ds_buf_0_2_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of mvt_top_util_ds_buf_0_2_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of mvt_top_util_ds_buf_0_2_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of mvt_top_util_ds_buf_0_2_util_ds_buf : entity is "util_ds_buf";
end mvt_top_util_ds_buf_0_2_util_ds_buf;

architecture STRUCTURE of mvt_top_util_ds_buf_0_2_util_ds_buf is
...
entity mvt_top_util_ds_buf_0_2 is
  ...
  attribute NotValidForBitStream of mvt_top_util_ds_buf_0_2 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of mvt_top_util_ds_buf_0_2 : entity is "mvt_top_util_ds_buf_0_2,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of mvt_top_util_ds_buf_0_2 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of mvt_top_util_ds_buf_0_2 : entity is "util_ds_buf,Vivado 2023.1";
end mvt_top_util_ds_buf_0_2;

architecture STRUCTURE of mvt_top_util_ds_buf_0_2 is
  ...
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 125000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN mvt_top_clk_in_n, INSERT_VIP 0";
begin
U0: entity work.mvt_top_util_ds_buf_0_2_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
