...
HD_PWD='C:/work/Technology/Vivado/adc_mvt/adc_mvt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mvt_top_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mvt_top_wrapper.tcl
