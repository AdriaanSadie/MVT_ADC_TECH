...
HD_PWD='C:/work/Technology/Vivado/adc_mvt/adc_mvt.runs/mvt_top_util_ds_buf_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mvt_top_util_ds_buf_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mvt_top_util_ds_buf_0_2.tcl
