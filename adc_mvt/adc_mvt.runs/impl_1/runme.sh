...
HD_PWD='C:/work/Technology/Vivado/adc_mvt/adc_mvt.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mvt_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mvt_top_wrapper.tcl -notrace
