...
#
# Script generated by Vivado on Tue Jul 16 14:18:06 +0200 2024
...
#
# Usage        : mvt_top.sh
#                mvt_top.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mvt_top.sh [-reset_run]
#                mvt_top.sh [-reset_log]
#                mvt_top.sh [-help]
#
...
#                script (type 'mvt_top.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_14 -libname zynq_ultra_ps_e_vip_v1_0_14 -libname xil_defaultlib -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_13 -libname xlconcat_v2_1_4 -libname xlconstant_v1_1_7 -libname xlslice_v1_0_2 -libname xbip_utils_v3_0_10 -libname c_reg_fd_v12_0_6 -libname xbip_dsp48_wrapper_v3_0_4 -libname xbip_pipe_v3_0_6 -libname xbip_dsp48_addsub_v3_0_6 -libname xbip_addsub_v3_0_6 -libname c_addsub_v12_0_15 -libname c_gate_bit_v12_0_6 -libname xbip_counter_v3_0_6 -libname c_counter_binary_v12_0_16 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_14 zynq_ultra_ps_e_vip_v1_0_14 xil_defaultlib lib_cdc_v1_0_2 proc_sys_reset_v5_0_13 xlconcat_v2_1_4 xlconstant_v1_1_7 xlslice_v1_0_2 xbip_utils_v3_0_10 c_reg_fd_v12_0_6 xbip_dsp48_wrapper_v3_0_4 xbip_pipe_v3_0_6 xbip_dsp48_addsub_v3_0_6 xbip_addsub_v3_0_6 c_addsub_v12_0_15 c_gate_bit_v12_0_6 xbip_counter_v3_0_6 c_counter_binary_v12_0_16)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "mvt_top.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mvt_top.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.mvt_top xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.mvt_top -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log mvt_top_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mvt_top.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mvt_top.sh [-help]\n\
Usage: mvt_top.sh [-step]\n\
Usage: mvt_top.sh [-lib_map_path]\n\
Usage: mvt_top.sh [-reset_run]\n\
Usage: mvt_top.sh [-reset_log]\n\
Usage: mvt_top.sh [-keep_index]\n\
Usage: mvt_top.sh [-noclean_files]\n\n\
