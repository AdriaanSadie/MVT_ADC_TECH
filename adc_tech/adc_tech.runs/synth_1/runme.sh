...
HD_PWD='C:/work/MVT_ADC_TECH/adc_tech/adc_tech.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adc_tech_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adc_tech_wrapper.tcl
