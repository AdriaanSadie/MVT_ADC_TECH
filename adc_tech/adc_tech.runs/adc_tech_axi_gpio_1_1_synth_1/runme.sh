...
HD_PWD='C:/work/Technology/Vivado/MVT_ADC_TECH/adc_tech/adc_tech.runs/adc_tech_axi_gpio_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adc_tech_axi_gpio_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adc_tech_axi_gpio_1_1.tcl
