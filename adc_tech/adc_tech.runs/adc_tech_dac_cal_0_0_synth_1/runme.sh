...
HD_PWD='C:/work/Technology/Vivado/MVT_ADC_TECH/adc_tech/adc_tech.runs/adc_tech_dac_cal_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adc_tech_dac_cal_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adc_tech_dac_cal_0_0.tcl
